...
namespace Indt.Unit.Domain.Entities.TestData;
...
public static class UserTestData
{
    ...
    /// </summary>
    private static readonly Faker<Proposta.Domain.Entities.PropostaEntity> UserFaker = new Faker<Proposal>()
        .RuleFor(u => u.Username, f => f.Internet.UserName())
        .RuleFor(u => u.Password, f => $"Test@{f.Random.Number(100, 999)}")
        .RuleFor(u => u.Email, f => f.Internet.Email())
        .RuleFor(u => u.Phone, f => $"+55{f.Random.Number(11, 99)}{f.Random.Number(100000000, 999999999)}")
        .RuleFor(u => u.Status, f => f.PickRandom(ProposalStatus.Active, ProposalStatus.Suspended))
    ...
    public static Proposta.Domain.Entities.PropostaEntity GenerateValidUser()
    {
