...
namespace Indt.Unit.Domain.Specifications.TestData;
...
public static class ActiveUserSpecificationTestData
{
    ...
    private static readonly Faker<Proposta.Domain.Entities.PropostaEntity> userFaker = new Faker<Proposal>()
        .CustomInstantiator(f => new Proposal {
            ...
            Status = f.PickRandom<ProposalStatus>(),
    ...
    public static Proposta.Domain.Entities.PropostaEntity GenerateUser(ProposalStatus status)
    {
