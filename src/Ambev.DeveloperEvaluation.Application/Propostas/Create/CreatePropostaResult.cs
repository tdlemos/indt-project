...
public class CreatePropostaResult
{
    ...
    public virtual IEnumerable<CreateBeneficiarioResult> Beneficiarios { get; set; }
    public virtual IEnumerable<CreateCoberturaResult> Coberturas { get; set; }
}

public class CreateCoberturaResult
{
    public int Id { get; set; }
...
public class CreateBeneficiarioResult
{
    public int Id { get; set; }
    public int PropostaId { get; set; }
