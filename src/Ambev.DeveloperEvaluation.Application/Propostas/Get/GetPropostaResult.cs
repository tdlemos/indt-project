...
public class GetPropostaResult
{
    ...
    public virtual IEnumerable<GetBeneficiarioResult> Beneficiarios { get; set; }
    public virtual IEnumerable<GetCoberturaResult> Coberturas { get; set; }
}

public class GetCoberturaResult
{
...
public class GetBeneficiarioResult
{
    public int PropostaId { get; set; }
