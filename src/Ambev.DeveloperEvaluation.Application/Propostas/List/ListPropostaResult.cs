...
public class ListPropostaResult
{
    ...
    public virtual IEnumerable<ListBeneficiarioResult> Beneficiarios { get; set; }
    public virtual IEnumerable<ListCoberturaResult> Coberturas { get; set; }
}

public class ListCoberturaResult
{
...
public class ListBeneficiarioResult
{
    public int PropostaId { get; set; }
