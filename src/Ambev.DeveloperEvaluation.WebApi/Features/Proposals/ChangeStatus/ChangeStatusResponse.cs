...
public class ChangeStatusResponse
{
    ...
    public virtual IEnumerable<ChangeStatusBeneficiarioResponse> Beneficiarios { get; set; }
    public virtual IEnumerable<ChangeStatusCoberturaResponse> Coberturas { get; set; }
}

public class ChangeStatusCoberturaResponse
{
    public int Id { get; set; }
...
public class ChangeStatusBeneficiarioResponse
{
    public int Id { get; set; }
