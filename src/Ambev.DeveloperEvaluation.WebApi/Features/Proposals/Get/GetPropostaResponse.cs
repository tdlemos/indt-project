...
namespace Indt.Proposta.WebApi.Features.Proposals.Get;

public class GetPropostaResponse
{
    ...
    public virtual IEnumerable<GetBeneficiarioResponse> Beneficiarios { get; set; }
    public virtual IEnumerable<GetCoberturaResponse> Coberturas { get; set; }
}

public class GetCoberturaResponse
{
