...
public class CreatePropostaRequest
{
    ...
    public virtual IEnumerable<CreateBeneficiarioRequest> Beneficiarios { get; set; }
    public virtual IEnumerable<CreateCoberturaRequest> Coberturas { get; set; }
}
...
public class CreateCoberturaRequest
{
    public string Nome { get; set; }
