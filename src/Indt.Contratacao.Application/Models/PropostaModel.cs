...
namespace Indt.Contratacao.Application.Models;
...
public class PropostaModel
{
    ...
    public virtual IEnumerable<BeneficiarioModel> Beneficiarios { get; set; }
    public virtual IEnumerable<CoberturaModel> Coberturas { get; set; }
}
